...
BATCH_SIZE = 16 # You might need to reduce batch size if 224x224 images cause memory issues
LEARNING_RATE = 1e-4
WEIGHT_DECAY = 1e-4
...
BEST_MODEL_PATH = os.path.join(OUTPUT_DIR, "best_model_fpn_coordreg.pth") # Changed model name
